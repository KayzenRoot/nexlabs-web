...
| --- | --- | --- | --- | --- | --- |
| CP-01 | `6322b3650e52119fd093dc9e410fde0a15075b9f` (`KayzenRoot/nexlabs-startup`) | `79309b5` | COMPLETE | `npm ci`; `npm run check`; `npm run test:e2e`; `npm audit --audit-level=high`; Wrangler dry-run | none |
