...
The current implementation desktop does not have the approved UGAS production environment available.

Until the founder explicitly changes this status:

- do not require UGAS for any implementation package;
- do not require Blender MCP;
